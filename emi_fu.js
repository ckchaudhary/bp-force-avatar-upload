jQuery(document).ready(function($){
	...
	html +=		"<input type='hidden' name='emi_fu_key' value='emi_fu' />";
	...
	if( $('#frm_emi_fu_uploader input[name="file"]').length == 0 ){
	    $('#frm_emi_fu_uploader').append("<input type='file' name='file' />");
	    $('#frm_emi_fu_uploader input[name="file"]').change(function(){
		emi_fu_file_selected();
	    });
	}
	
	$('#frm_emi_fu_uploader input[name="file"]').trigger('click');
	return false;
    });
